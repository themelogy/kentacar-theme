...
<aside class="col-md-3 sidebar" id="sidebar">
        ...
        <div class="widget-content">
            <ul id="tabs" class="nav nav-justified">
                <li><a href="#tab-s1" data-toggle="tab">
                        <small>{!! trans('themes::blog.titles.latest posts') !!}</small>
                    </a></li>
                <li class="active"><a href="#tab-s2" data-toggle="tab">
                        <small>{!! trans('themes::blog.titles.popular posts') !!}</small>
                    </a></li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tab-s1">
                    <div class="recent-post">
                        @foreach(Blog::latest(3) as $latest)
                            <div class="media">
                                <a class="pull-left media-link" href="{{ $latest->url }}">
                ...
                <div class="tab-pane fade in active" id="tab-s2">
                    <div class="recent-post">
                        @foreach(Blog::popular(3) as $latest)
                            <div class="media">
                                <a class="pull-left media-link" href="{{ $latest->url }}">
                                    <img class="media-object" src="{{ $latest->present()->firstImage(70,70,'fit',80) }}" alt="{{ $latest->title }}">
                                    <i class="fa fa-plus"></i>
    ...
    <div class="widget shadow widget-helping-center">
        ...
        <div class="widget-content">
            <p>{{ trans('themes::theme.contact.help us') }}</p>
